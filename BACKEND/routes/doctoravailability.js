...
router.put(
  ...
  availableController.updatAvailable
);

/* delete data */
router.delete("/deletetime", availableController.deleteAvailable);
/* delete data */
router.delete("/deletetime/:id", availableController.deleteAvailableSingle);

/* get data by doctorID */

router.get("/doctortime/:id", availableController.DOCTORIDSEARCH);
